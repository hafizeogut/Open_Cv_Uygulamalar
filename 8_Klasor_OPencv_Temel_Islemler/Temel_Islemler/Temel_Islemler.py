...
img=cv2.imread("Usak64.jpg")#resim uzantısı ile birlikte yazdırıldı

dimension=img.shape#verilen resmin şeklini boy ,en,kanal özellikleri alındı.Dimension:boyut
print(dimension)


color=img[100,150]#150 ,200  kordinatındaki renk değerlerini color değişkeninde tutulur.
print("BGR:",color)
...
img[420,500,0]=200#blue değerinin renk olarak karşılığını değiştirme işlemi yapıldı
