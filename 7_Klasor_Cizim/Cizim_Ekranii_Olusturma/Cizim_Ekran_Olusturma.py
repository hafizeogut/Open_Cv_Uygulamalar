...
cv2.imshow("canvas",canvas)#Tuvalin gösterileceği pencerenin adı,Tuval
cv2.waitKey(0)# Tuval girdiğim değer kadar ekranda tutulur mili/saniye
cv2.destroyAllWindows()# tüm pencereleri kapatmak adına önemlidir


print(canvas)#oluşturduğum değerler aslında arkada matris, yazdırdıö